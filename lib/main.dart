...
import 'features/multi_user/test_rls_policies.dart';
...
void main() async {
  ...
  // 🧪 RLS Policy Test (nur für Entwicklung)
  await RLSPolicyTester.testRLSPolicies();
  await RLSPolicyTester.testCrossUserAccess();

...
abstract class FoodTipsLocalDataSource {
  ...
  Future<void> cacheFoodTips(String foodName, String storageTips, String spoilageTips);
}
...
class FoodTipsLocalDataSourceImpl implements FoodTipsLocalDataSource {
  ...
  Future<void> _insertPredefinedFoods(Database db) async {
    ...
    final predefinedFoods = [
      ...
      // Milchprodukte
      {
        ...
        'spoilage_indicators': '• Säuerlicher Geruch\n• Klumpige Konsistenz\n• Gelbliche Verfärbung\n• Säuerlicher Geschmack',
      },
      {
        'food_name': 'Joghurt',
        'category': 'Milchprodukte',
        'storage_tips': '• Im Kühlschrank lagern\n• Original-Verpackung nutzen\n• Bei 4°C aufbewahren\n• Deckel geschlossen halten',
        'spoilage_indicators': '• Schimmelbildung an Oberfläche\n• Säuerlicher Geruch\n• Wässrige Konsistenz\n• Gelbliche Verfärbung',
      },
      {
        'food_name': 'Käse',
        'category': 'Milchprodukte',
        'storage_tips': '• Im Kühlschrank lagern\n• In Käsepapier wickeln\n• Nicht in Plastik\n• Hart- und Weichkäse trennen',
        'spoilage_indicators': '• Ungewöhnlicher Schimmel\n• Ammoniakgeruch\n• Schmierige Konsistenz\n• Bitterer Geschmack',
      },
      {
        'food_name': 'Butter',
        'category': 'Milchprodukte',
        'storage_tips': '• Im Kühlschrank lagern\n• Original-Verpackung nutzen\n• Vor Licht schützen\n• Butterdose verwenden',
        'spoilage_indicators': '• Ranziger Geruch\n• Gelbliche Verfärbung\n• Schimmelbildung\n• Bitterer Geschmack',
      },
      ...
      // Brot & Getreide
      {
        'food_name': 'Brot',
        'category': 'Backwaren',
        'storage_tips': '• In Brotkasten aufbewahren\n• Nicht im Kühlschrank\n• In Papiertüte lagern\n• Angeschnittene Seite nach unten',
        'spoilage_indicators': '• Grüner oder weißer Schimmel\n• Säuerlicher Geruch\n• Harte, trockene Konsistenz\n• Verfärbungen sichtbar',
      },
      {
        'food_name': 'Nudeln',
        'category': 'Getreide',
        'storage_tips': '• Trocken und kühl lagern\n• In luftdichtem Behälter\n• Vor Insekten schützen\n• Original-Verpackung nutzen',
        'spoilage_indicators': '• Insektenbefall sichtbar\n• Muffiger Geruch\n• Verfärbungen\n• Schimmelbildung',
      },
      {
        'food_name': 'Reis',
        'category': 'Getreide',
        'storage_tips': '• Trocken und kühl lagern\n• In luftdichtem Behälter\n• Vor Feuchtigkeit schützen\n• Regelmäßig kontrollieren',
        'spoilage_indicators': '• Insektenbefall\n• Muffiger Geruch\n• Verfärbungen\n• Schimmelbildung',
      },
      ...
      // Kartoffeln & Knollen
      {
        ...
        'category': 'Gemüse',
        'storage_tips': '• Kühl und dunkel lagern\n• Nicht im Kühlschrank\n• Getrennt von Zwiebeln\n• Grüne Stellen entfernen',
        'spoilage_indicators': '• Grüne Verfärbung\n• Weiche, faulige Stellen\n• Süßlicher Geruch\n• Austriebe vorhanden',
      },
      ...
      // Eier
      {
        ...
        'spoilage_indicators': '• Schwefelgeruch beim Aufschlagen\n• Wässriges Eiweiß\n• Verfärbtes Eigelb\n• Schwimmt im Wasser',
      },
      ...
      },
      {
        'food_name': 'Zucker',
        'category': 'Basics',
        'storage_tips': '• Trocken lagern\n• In luftdichtem Behälter\n• Vor Feuchtigkeit schützen\n• Bei Raumtemperatur',
        'spoilage_indicators': '• Klumpenbildung\n• Verfärbungen\n• Fremdgeruch\n• Insektenbefall',
      },
      {
        'food_name': 'Öl',
        'category': 'Basics',
  ...
  @override
  Future<void> cacheFoodTips(String foodName, String storageTips, String spoilageTips) async {
    try {
      final db = await database;
      await db.insert(
        _tableName,
